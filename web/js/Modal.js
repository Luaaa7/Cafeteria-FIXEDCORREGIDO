/* =============================================
   CLASE: Modal
   Responsabilidad única: mostrar/ocultar una ventana
   emergente reutilizable (éxito, error, información).
   No depende de ninguna página en particular: cualquier
   script puede llamar a new Modal().mostrar({...})
   ============================================= */
